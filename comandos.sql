...
-- ====================================
-- SCRIPT PARA ADICIONAR COLUNA numero_cliente NA TABELA cliente    
-- ====================================
-- Este script adiciona a coluna numero_cliente na tabela cliente,
-- popula com números sequenciais e cria uma trigger para novos registros.
-- Certifique-se de fazer backup da tabela antes de executar este script.
-- ====================================


-- PASSO 1: FAZER BACKUP DA TABELA atua existente
CREATE TABLE cliente_backup AS SELECT * FROM cliente;

-- PASSO 2: ADICIONAR A COLUNA numero_cliente na tabela cliente
-- FORMATO: 001, 002, 003...
...
-- PASSO 4: ATUALIZAR OS 79 ou mais REGISTROS EXISTENTES
...
-- TESTE 2: Inserir novo cliente completo "Caso seja necessário" (deve gerar 080)
INSERT INTO cliente (
    nome, 
    email, 
    telefone, 
...
-- Buscar cliente por número (para a API PHP)
SELECT 
    id,
    numero_cliente,
    nome,
